function estimatedbone_proc = mmodeDepthDetection(mmode, depth_unit, new_seed, peakparam, movwinparam, clusterparam, outlierparam, smoothingparam, axis_result, display_process)
...
%   new_seed         Initial depth guess (in mm) for the clustering algorithm
...
while idx_startwindow <= length_data - length_halfwindow
    ...
    [f, data_cleaned, ~, fig2] = estimateBoneCluster_v3( allpeaks_mm, new_seed, clusterparam, outlierparam, smoothingparam, display_process);
